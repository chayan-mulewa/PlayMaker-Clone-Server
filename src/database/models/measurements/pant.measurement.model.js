...
const pantMeasurementSchema = new Schema(
  {
    userId: {
...
pantMeasurementSchema.index({ userId: 1, profileName: 1 });
...
const PantMeasurement = model("PantMeasurement", pantMeasurementSchema);

module.exports = PantMeasurement;
